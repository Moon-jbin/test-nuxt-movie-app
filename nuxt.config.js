export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid:'description', property:'description', content:'The OMDb API is a RESTful web service to obtain movie information, all content and images on the site are contributed and maintained by our users.' },
      { hid:'og:image', property:'og:image', content:'https://cdn.pixabay.com/photo/2017/12/25/10/47/toy-3038204_960_720.jpg' },
